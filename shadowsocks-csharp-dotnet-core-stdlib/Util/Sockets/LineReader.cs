...
namespace Shadowsocks.Std.Util.Sockets
{
    public class LineReader
    {
        ...
        public LineReader(WrappedSocket socket,
                          Func<string, object, bool> onLineRead,
                          ...
                          object state)
        {
            ...
            _onLineRead = onLineRead ?? throw new ArgumentNullException(nameof(onLineRead));
        ...
        #endregion Boyer-Moore string search
    }
}