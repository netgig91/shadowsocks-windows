...
namespace Shadowsocks.View
{
    public class MenuViewController
    {
        ...
        #endregion MenuItems and MenuGroups
        ...
        private void controller_VerboseLoggingStatusChanged(object sender, EventArgs e)
        {
            VerboseLoggingToggleItem.Checked = controller.GetConfigurationCopy().isVerboseLogging;
        }

        private void controller_ShowPluginOutputChanged(object sender, EventArgs e)
        {
