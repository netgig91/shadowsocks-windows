...
namespace Shadowsocks.View
{
    public partial class LogForm : Form
    {
        ...
        private Queue<TrafficInfo> trafficInfoQueue = new Queue<TrafficInfo>();
        private const int queueMaxLength = 60;
        private long lastInbound, lastOutbound;
        private long maxSpeed = 0, lastMaxSpeed = 0;
        private const long minScale = 50;
        private BandwidthScaleInfo bandwidthScale;
        private List<float> inboundPoints = new List<float>();
        private List<float> outboundPoints = new List<float>();
        private TextAnnotation inboundAnnotation = new TextAnnotation();
        private TextAnnotation outboundAnnotation = new TextAnnotation();

        #endregion Traffic Chart
        ...
        #endregion Clean up the content in LogMessageTextBox.
        ...
        #endregion Change the font settings applied in LogMessageTextBox.

        #region Trigger the log messages to wrapable, or not.

        private bool wrapTextTrigger = false;
        private bool wrapTextTriggerLock = false;
        ...
        #endregion Trigger the log messages to wrapable, or not.

        #region Trigger the window to top most, or not.

        private bool topMostTrigger = false;
        private bool topMostTriggerLock = false;
        ...
        #endregion Trigger the window to top most, or not.
